    ...
    <div className="landing-container">
      <nav className="landing-nav">
        <Link to="/" className="landing-logo">
          <img src="/logo.png" alt="Zipp Logo" style={{ height: '140px', width: 'auto', mixBlendMode: 'multiply', margin: '-30px 0' }} />
        </Link>
      ...
      <footer className="landing-footer">
        <div className="landing-logo">
          <img src="/logo.png" alt="Zipp Logo" style={{ height: '100px', width: 'auto', mixBlendMode: 'multiply' }} />
        </div>
