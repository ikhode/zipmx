...
// ../.wrangler/tmp/bundle-Wq5ETd/checked-fetch.js
...
var getSecret = /* @__PURE__ */ __name((c) => c.env.JWT_SECRET || "dev-secret-keep-it-safe", "getSecret");
...
var authGuard = /* @__PURE__ */ __name((c, next) => jwt({ secret: getSecret(c), alg: "HS256" })(c, next), "authGuard");
...
// ../.wrangler/tmp/pages-bTminO/functionsRoutes-0.6607237614922082.mjs
var routes = [
  {
    routePath: "/api/:route*",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-Wq5ETd/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-Wq5ETd/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.19429245638868997.mjs.map
