...
// .wrangler/tmp/bundle-JkiFYE/checked-fetch.js
...
// .wrangler/tmp/pages-vymFlZ/functionsWorker-0.3053815181052131.mjs
...
app.get("/geocoding/address", async (c) => {
  ...
  if (lat && lon) {
    ...
    url += `&viewbox=${lLon - d},${lLat + d},${lLon + d},${lLat - d}&bounded=1`;
  }
  try {
...
// .wrangler/tmp/bundle-JkiFYE/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-JkiFYE/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3053815181052131.js.map
